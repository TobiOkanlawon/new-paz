...
const BVN_Modal: React.FC<BvnmPropTypes> = ({ isOpen, onClose }) => {
      ...
      <Modal isOpen={isOpen} onClose={onClose}>
        {
            isBVNConfirmed ? (
                ...
                <div>
                    ...
                    <p className={styles.modalDetails}>You can verify your identity on PAZ with your BVN</p>
                    ...
                    {({ isSubmitting }) => (
                        ...
                        <div className={styles.inputGroup}>
                            <label className={styles.labels} htmlFor="bvn">BVN</label>
                            <Field
                            ...
                            />
                            <p className={styles.bvnGuide}>To get your BVN, dial *565*0#</p>
                        </div>
            
                        <div className={styles.inputGroup}>
                            <label className={styles.labels} htmlFor="dob">Date of Birth</label>
                            <Field
                            className={styles.inputs}
                            type="date"
                            name="dob"
