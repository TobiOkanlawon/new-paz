...
const LeftCaurosel = () => {
    const bgImages = [
        ...
        { bg: "/images/leftBG31.png", text: "PAZ is a simple and secure platform that helps people save smarter and manage payments with ease. It is built for everyday users who want clarity, control, and peace of mind when handling their money." },
    ]
        ...
        <div className={styles.container}>
            <div className={styles.bgContainer}>
                <div className={styles.logoContainer}>
                    <Image src="/images/pazLeftBG.png" alt="PAZ Logo" width={158} height={51} className={styles.logo} />
