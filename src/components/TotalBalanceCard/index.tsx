...
const TotalBalanceCard: React.FC<TotalBalanceCardProps> = ({
  ...
  return (
    <div
      style={isPending ? { minWidth: "45vw", flexGrow: "1" } : undefined}
      className={styles.totalBalanceCard}
    >
      <p>{header}</p>
      <div className={styles.contentContainer}>
        ...
        {buttonText && (
          <button
            style={isPending ? { width: "70%" } : { width: "100%" }}
