...
const SavingsAlert: React.FC<SavingsAlertProps> = ({ isActive, isSuccessful, onClose, message }) => {
    ...
    return (
        <div className={`${styles.alertContainer} ${fadingOut ? styles.fadeOut : styles.fadeIn}`}>
            {isSuccessful ? (
