...
import styles from "./withdrawTargetSavingsModal.module.css";
...
const WithdrawTargetSavingsModal = ({
  open,
  onClose,
  accountName,
  currentSavings,
  ...
  return (
    <ModalShell open={open} onClose={onClose} title="Withdraw from Target savers" width={700}>
...
export default WithdrawTargetSavingsModal;