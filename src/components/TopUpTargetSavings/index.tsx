...
import styles from "./topUpTargetSavings.module.css";
...
const TopUpTargetSavingsModal = ({
  ...
  return (
    <ModalShell open={open} onClose={onClose} title="Top up Target Savings" width={700}>
...
export default TopUpTargetSavingsModal;