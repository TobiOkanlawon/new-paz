  ...
  const keyNotes = [
    {
      ...
      icon: "/images/onboarding1.png",
      iconBG: "#E5EAFB",
    },
    {
      title: "Secure and Private Authentication",
      description: "Enterprise grade security to keep your data safe.",
      icon: "/images/onboarding21.png",
      iconBG: "#F9EAD1",
    },
    {
      title: "PAZ Family Savings",
      description:
        "Build meaningful savings as a family, with shared goals and real progress.",
      icon: "/images/onboarding31.png",
      iconBG: "#E6FCEE",
    },
    {
      title: "PAZ Loans",
      description:
        "Access loans with confidence, fair rates, clear terms, no stress",
      icon: "/images/onboarding4.png",
      iconBG: "#E0DFFD",
    },
  ];
  return (
