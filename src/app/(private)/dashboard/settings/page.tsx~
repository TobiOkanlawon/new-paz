...
import { LuLock, LuHeadphones, LuKey, LuSmartphone, LuShield, LuPhone, LuMail } from 'react-icons/lu'
  ...
  return (
    <div className={styles.page}>
      ...
      <div className={styles.hero}>
        ...
        <p className={styles.heroSub}>Manage your account preferences and security</p>
      </div>
      ...
      <div className={styles.body}>
        ...
        <nav className={styles.tabs}>
          ...
          >
            <span className={styles.tabIcon}><LuLock size={20} /></span>
            Account Settings
          </button>
          ...
          >
            <span className={styles.tabIcon}><LuHeadphones size={20} /></span>
            Customer Support
          </button>
        </nav>
        ...
        <div className={styles.panel}>
          ...
          {activeTab === 'account' && (
            <>
              ...
              <p className={styles.sectionDesc}>Keep your account safe with these settings</p>

              {/* Change Password */}
              <div className={styles.secCard}>
                <div className={styles.secCardLeft}>
                  <div className={styles.secCardIconWrap}><LuKey size={24} /></div>
                  <div>
              ...
              <div className={styles.secCard}>
                <div className={styles.secCardLeft}>
                  <div className={styles.secCardIconWrap}><LuShield size={24} /></div>
                  <div>
                    <p className={styles.secCardTitle}>Security Question</p>
                    <p className={styles.secCardDesc}>
                      Set a personal question to confirm your identity when needed.
                    </p>
                  </div>
                </div>
                <button onClick={()=>{
                  setSecurityQuestionSet(true)
                }} className={styles.secCardBtn}>Set Question</button>
              </div>
            </>
          )}
          ...
          {activeTab === 'support' && (
            <>
              ...
              <p className={styles.sectionDesc}>We're here to help — reach out via any channel below</p>

              <div className={styles.supportGrid}>
                {/* Phone */}
                <div className={styles.supportCard}>
                  <div className={styles.supportCardTop}>
                    <div className={`${styles.supportIconWrap} ${styles.supportIconBlue}`}><LuPhone size={24} /></div>
                    <div>
                      <p className={styles.supportCardLabel}>Customer Care Line</p>
                ...
                <div className={styles.supportCard}>
                  <div className={styles.supportCardTop}>
                    <div className={`${styles.supportIconWrap} ${styles.supportIconGreen}`}><LuMail size={24} /></div>
                    <div>
                      <p className={styles.supportCardLabel}>Send Us a Mail</p>
                      <p className={styles.supportCardValue}>inquiry@mypazfinance.com</p>
                    </div>
                  </div>
                  <a href="mailto:inquiry@mypazfinance.com" className={styles.supportLink}>
                    Send Email →
                  </a>
                </div>
              </div>
