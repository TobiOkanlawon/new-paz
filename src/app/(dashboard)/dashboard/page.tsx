    ...
    <div className={styles.container}>        
        <div className={styles.totals}>
            <div className={`${styles.totalCategories} ${styles.lightBlue}`}>
                ...
                <h3>
                  ₦ {showSavings ? '20,000' : '****'}{' '}
                  <span style={{cursor:'pointer', fontSize: '1rem'}} onClick={() => setShowSavings(s => !s)}>
            ...
            <div className={`${styles.totalCategories} ${styles.darkBlue}`}>
                ...
                <h3>
                  ₦ {showLoans ? '20,000' : '****'}{' '}
                  <span style={{cursor:'pointer', fontSize: '1rem'}} onClick={() => setShowLoans(s => !s)}>
            ...
            <div className={`${styles.totalCategories} ${styles.purple}`}>
                ...
                <h3>
                  ...
                  <span style={{cursor:'pointer', fontSize: '1rem'}} onClick={() => setShowInvestments(s => !s)}>
    ...
    <div className={styles.mobileContainer}>
            ...
            <div className={styles.mobileScroll} ref={mobileScrollRef}>
                <div className={styles.mobileTotals}>
                    <div className={`${styles.mobileTotalCategories} ${styles.lightBlue}`}>
                        ...
                        <h3>
                            ₦ 20,000 <Image src='/eyeOff.png' alt='eyes off' width={20} height={20}/>
                        </h3>
                    </div>
                    <div className={`${styles.mobileTotalCategories} ${styles.darkBlue}`}>
                        <div className={styles.textIcon}>
                            <p>Total Loans Collected 
                            </p>
                            <Image 
                                src='/dashboardLoan.png'
                                alt='Dashboard Loan'
                    ...
                    <div className={`${styles.mobileTotalCategories} ${styles.purple}`}>
                        <div className={styles.textIcon}>
                            <p>Total Investments 
                            </p>
                            <Image 
        ...
        <div className={styles.mobileBankActions}>
            <div className={styles.bankActions}>
                <Image src='/mobileSavings.png' alt='Mobile Savings' width={40} height={40}  />
            </div>
            <div className={styles.bankActions}>
                <Image src='/mobileLoans.png' alt='Mobile Loans' width={40} height={40}  />
            </div>
            <div className={styles.bankActions}>
                <Image src='/mobileInvestments.png' alt='Mobile Investments' width={40} height={40}  />
            </div>
            <div className={styles.bankActions}>
        ...
        <div className={styles.mobileRecentActivities}>
            ...
            <div className={styles.mobileActivity}>
                <Image 
                    src='/activityLogo.png' alt='Activity Logo' width={50} height={50}
                />
            ...
            <div className={styles.mobileActivity}>
                ...
                />
                <div className={styles.activityText}>
                    <h5><span>₦ 20,000</span> withdrawn from savings</h5>
                    <p>2 days ago</p>
                </div>
            </div>
        </div>
